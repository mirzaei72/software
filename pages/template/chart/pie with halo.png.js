(function() {
  ...
  var sHtml= "<div class='frame-build' _config='default-large-small' _zindex='995' _left='" + taskCfg.mouseX + "' _top='" + taskCfg.mouseY + "' _width='640' _height='480'><iframe class='echarts-pie build' frameborder='0' border='0' _widget=\"[['legend=','center'],['percent=','true'],['table=','pie',,,'value'],[,,'&lt;inner:&gt;','68% happy','68'],[,,,'29% live hard','29'],[,,,'3% been happy','3']]\" _src='/software/slide11/$plugins/echarts_pie.html' src='/software/slide11/$plugins/echarts_pie.html'></iframe></div>\n";
