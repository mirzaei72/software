(function() {
  ...
  var sHtml = "<article id='" + sNewId + "'>\n" +
              "<div _config='default-large-small default-looser-impacted' _zindex='1000' _left='-400' _top='-336' _width='780' style='text-align:center;'><h3>Slide with bullet points</h3></div>\n" +
              "<div _config='default-large-small default-looser-impacted p1-p2-p3-p0 default-square-circle' _zindex='1000' _left='-380' _top='-260' _width='690'><ul><li>item1</li><li>item2</li><li>item3</li></ul></div>\n" +
              "</article>\n";
