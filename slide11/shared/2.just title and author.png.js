(function() {
  ...
  var sHtml = "<article id='" + sNewId + "'>\n" +
              "<div class='ebook-title' _config='default-large-small default-looser-impacted default-hidden' _zindex='1000' _left='-348' _top='-144' _width='680'><h1>Title Goes Here Up<br>To Two Lines</h1></div>\n" +
              "<div _config='default-large-small default-looser-impacted p1-p2-p3-p0' _zindex='1000' _left='-344' _top='3' _width='500'><p>Your name<br>May 1, 2013</p></div>\n" +
              "</article>\n";
