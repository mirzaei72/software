(function() {
  ...
  var sHtml = "<article id='" + sNewId + "'>\n" +
              "<div _config='default-large-small default-looser-impacted' _zindex='1000' _left='-400' _top='-336' _width='780' style='text-align:center;'><h3>Simple slide with header and text</h3></div>\n" +
              "<div _config='default-large-small default-looser-impacted p1-p2-p3-p0' _zindex='1000' _left='-380' _top='-260' _width='690'><p>This is a slide with just text. This is a slide with just text. This is a slide with just text. This is a slide with just text. This is a slide with just text.</p></div>\n</article>\n" +
              "</article>\n";
